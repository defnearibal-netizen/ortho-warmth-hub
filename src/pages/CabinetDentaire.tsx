...
import { Stethoscope, Heart, Sparkles, Shield, ArrowRight, Calendar } from "lucide-react";
...
const services = [
  {
    ...
    description: "Traitement des caries, détartrage, polissage et soins préventifs.",
  },
  {
    icon: Heart,
    title: "Esthétique dentaire",
    description: "Blanchiment, facettes et restaurations esthétiques pour un sourire éclatant.",
  },
  {
    icon: Sparkles,
    title: "Prothèses dentaires",
    description: "Couronnes, bridges et prothèses pour restaurer votre dentition.",
  },
  {
    icon: Shield,
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-xl text-white/80">
              Des soins dentaires complets dans un environnement moderne et chaleureux.
            </p>
          </div>
        </div>
      </section>
...
export default CabinetDentaire;
