...
import { Calendar, Phone, ClipboardList, Pencil, FileText, RefreshCw, Smile } from "lucide-react";
import iconTooth from "@/assets/icon-tooth.png";
          ...
          <div className="mt-12">
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 md:gap-6">
              ...
              <div className="text-center flex flex-col items-center">
                ...
                <div className="w-px h-6 bg-border mt-auto" />
                <div className="w-16 h-16 rounded-full bg-secondary flex items-center justify-center mt-2">
                  <img src={iconTooth} alt="Dent" className="w-7 h-7" style={{ filter: 'invert(33%) sepia(15%) saturate(1200%) hue-rotate(340deg) brightness(90%) contrast(90%)' }} />
                </div>
              </div>
